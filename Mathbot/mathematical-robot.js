let bothName = "MathBot";
let greeting = `Hi there! My name is ${bothName} I am here to teach you about the Math object!`;
console.log(greeting);
console.log("The Math.random() method returns a pseudo random number between 0 and less than 1.");
let randomNum = Math.random();
console.log(randomNum);
console.log("Now, generate a random number terween two values.");
let min = 1;
let max = 100; 
let randomNum2 = Math.random() * (max - min) + min;
console.log(randomNum2);
console.log("The Math.floor() method rounds the value down the nearest whole integer.");
